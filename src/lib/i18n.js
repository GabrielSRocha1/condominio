...
const EN = {
  ...
  "País do condomínio": "Condominium country", "País do telefone (DDI)": "Phone country (dialing code)",
  "Define o DDI e a máscara dos telefones cadastrados e do envio por WhatsApp.": "Sets the dialing code and phone format for records and WhatsApp sending.",
  "Número fora do padrão do país selecionado": "Number doesn't match the selected country's format", "dígitos": "digits",
  "Telefone fora do padrão do país — confira o DDI e a quantidade de dígitos": "Phone doesn't match the country's format — check the dialing code and digit count",
  "Telefone: informe com DDD/código de área; número de outro país começa com + e o DDI (ex.: +595 981 123456).": "Phone: include the area code; numbers from another country start with + and the dialing code (e.g. +595 981 123456).",
...
const ES = {
  ...
  "País do condomínio": "País del condominio", "País do telefone (DDI)": "País del teléfono (código)",
  "Define o DDI e a máscara dos telefones cadastrados e do envio por WhatsApp.": "Define el código de país y el formato de los teléfonos registrados y del envío por WhatsApp.",
  "Número fora do padrão do país selecionado": "Número fuera del formato del país seleccionado", "dígitos": "dígitos",
  "Telefone fora do padrão do país — confira o DDI e a quantidade de dígitos": "Teléfono fuera del formato del país — revise el código y la cantidad de dígitos",
  "Telefone: informe com DDD/código de área; número de outro país começa com + e o DDI (ex.: +595 981 123456).": "Teléfono: con código de área; un número de otro país empieza con + y el código del país (ej.: +595 981 123456).",
